...
hold on
%plot(log10(Cvap./1e6.*sc./LO),log10(Ntot(1,:)./1e6),'ks')
% hold on
% plot(log10(Cvap(1,:)./1e6.*sc./LO),log10(Ntot(2,:)./1e6),'bp')
...
% figure
%plot(log10(Cvap./1e6.*sc./LO),log10(N3(1,:)./1e6),['ks'])
% hold on
% plot(log10(Cvap(1,:)./1e6.*sc./LO),log10(N3(2,:)./1e6),['bp'])
...
plot((lcv),(lN3_i(1,:)),['k' mar])
% hold on
% plot((lcv(1,:)),(lN3_i(2,:)),['b' mar])
